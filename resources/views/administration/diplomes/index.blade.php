...
<section class="content-header">
     ...
     <ol class="breadcrumb">
       <li><a href="{{ url('/administration') }}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
         <li class="active"><a href="{{ url('/administration/diplomes/'. $user->id .'/') }}">تعديل شهادات الأستاذ</a></li>
     ...
     <div class="row">
       <div class="col-xs-12 ">
         ...
         <div class="box-header with-border">
              <h3 class="box-title">قائمة شهادات الاستاذ     {{$user->nom }} {{ $user->prenom}} </h3>
...
<script type="text/javascript">
    ...
    var table = $('#data').DataTable({
        "processing": true,
        ajax: '{{ url("/administration/diplomes/data/"." $user->id") }}',
        columns: [
            {data: 'id', name: 'id'},
            {data: 'nom_Dip', name: 'nom_Dip'},
            {data: 'Date_Dip', name: 'Date_Dip'},
