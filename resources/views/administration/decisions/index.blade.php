...
<section class="content-header">
     ...
     <ol class="breadcrumb">
       ...
       <li class="active"><a href="{{ url('/administration/decisions') }}">ادارة القرارات</a></li>
     </ol>
   </section>
     ...
     <div class="row">
       <div class="col-xs-12 ">
         ...
         <div class="box-header with-border">
              <h3 class="box-title">قائمة القرارات</h3>
           ...
           <div class="box-body">
             ...
             <table id="data" class="table table-bordered table-hover" cellspacing="0">
               ...
               <tr>
                 <th>رقم القرار</th>
                 <th>الموضوع</th>
                   <th>لقب كاتب القرار</th>
                   <th>اسم كاتب القرار</th>
                   <th>التحكم</th>
               </tr>
               </thead>
              <tbody>
...
<script type="text/javascript">
    ...
    var table = $('#data').DataTable({
        "processing": true,
        ajax: '{{ url('/administration/decisions/data') }}',
        columns: [
            {data: 'numero', name: 'conge.numero'},
            {data: 'sujet', name: 'conge.sujet'},
            {data: 'nom', name: 'administrateur.nom'},
            {data: 'prenom', name: 'administrateur.prenom'},
